    ...
    <div class="p-8 bg-gray-100 min-h-screen">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-3">
                ...
                {{-- Excluir via JS --}}
                <button type="button" class="flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-red-700" onclick="deleteGroup('{{ $group['uuid'] ?? '' }}')">
