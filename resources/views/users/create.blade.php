        ...
        <div>
            <a href="{{ route('painelusers') }}"
               class="flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                <svg class="w-5 h-5 mr-2 -ml-1 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                Voltar para a Lista
            </a>
        </div>
    </div>
        ...
        <form action="{{-- {{ route('users.store') }} --}}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" placeholder="Ex: joao.silva"
                               class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                               required>
                        <p class="mt-2 text-xs text-gray-500">Será usado para o login. Sem espaços ou caracteres especiais.</p>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    {{-- Comentário --}}
                    <div>
                        <label for="comment" class="block text-sm font-medium text-gray-700">Comentário / Observações</label>
                ...
                <div class="md:col-span-2 mt-4 border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="authorizedkeys" id="authorizedkeys" rows="4" placeholder="Cole uma ou mais chaves públicas SSH, uma por linha."
                            ...
                            <p class="mt-2 text-xs text-gray-500">Para acesso sem senha via terminal. Deixe em branco se não for necessário.</p>
                        </div>
                    </div>
                </div>
            </div>
