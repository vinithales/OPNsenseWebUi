        ...
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('settings.index') }}"
                    class="flex items-center justify-between px-2 py-2 rounded-md {{ request()->routeIs('settings.*') ? 'text-white bg-green-700' : 'text-gray-300 hover:bg-gray-700' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2 {{ request()->routeIs('settings.*') ? 'text-white' : 'text-gray-400' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
